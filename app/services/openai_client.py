...
def analyze_image_base64(image_base64: str) -> dict:
    ...
    system_prompt = (
        ...
        "Identify the dish name, list all ingredients with their estimated weight (in grams), and provide basic nutrition information. "
        "For each ingredient include calories, allergens (if any), and key macronutrients and micronutrients. "
