...
- **Основна:** користувачі мобільного додатку **BroCalories** (Android (Google Play) + iOS (Apple App Store) — Flutter cross-platform). Технічний рівень — нетехнічні. Кількість — TBD (питання 🔴 Q-001).
